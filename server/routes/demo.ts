 ...
 *
 * All routes require JWT auth (mounted after the requireAuth middleware in index.ts).
 * Only usable in demo/dev mode (refuse if NODE_ENV=production AND no demo flag).
 */
