...
router.post("/:phone/read", async (req, res) => {
  await markThreadRead(decodeURIComponent(req.params.phone))
  res.json({ ok: true })
})

/**
 * POST /api/conversations/seed-demo
 * Creates fake lead reply threads for offline demo use.
 */
router.post("/seed-demo", async (req, res) => {
  try {
    ...
    const meta1 = {
      leadId: "fb-001", leadName: "James Whitfield",
      propertyAddress: "17 Grand Arch Way, Berwick VIC", email: "james.whitfield@gmail.com",
    }
    ...
    const meta2 = {
      leadId: "fb-002", leadName: "Claire Thompson",
      propertyAddress: "17 Grand Arch Way, Berwick VIC", email: "claire.thompson@hotmail.com",
    }
    ...
    const meta3 = {
      leadId: "fb-003", leadName: "Michael Tran",
      propertyAddress: "17 Grand Arch Way, Berwick VIC", email: "m.tran@yahoo.com.au",
    }
