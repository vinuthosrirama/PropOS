...
const SMS: Record<string, string[]> = {
  "New Listing Match": [
    "Hi {{fn}}, thanks for coming to {{soldAddr}}. Got another that suits, {{details}} at {{activeAddr}}. {{cta}} Cheers, {{an}}",
    "Hi {{fn}}, {{an}} here. After {{soldAddr}}, thought of {{activeAddr}} for you, {{details}}. {{cta}} Cheers, {{an}}",
    "Hi {{fn}}, {{an}} from the {{soldAddr}} open. {{activeAddr}} just listed, {{details}}. {{cta}} {{an}}",
    "Hi {{fn}}, loved chatting at {{soldAddr}}. Have one at {{activeAddr}}, {{details}}. {{cta}} Cheers, {{an}}",
  ],
  "Market Pulse": [
    "Hi {{fn}}, {{an}} here. Market's moving, {{activeAddr}} just listed, {{details}}. Thought of you from {{soldAddr}}. {{cta}} {{an}}",
    "Hi {{fn}}, quick one from {{an}}. Since {{soldAddr}}, new one at {{activeAddr}}, {{details}}. {{cta}} Cheers, {{an}}",
    "Hi {{fn}}, {{an}} here. Suburb update, {{activeAddr}} just came on, {{details}}. {{cta}} Cheers, {{an}}",
  ],
  "Price Movement Alert": [
    "Hi {{fn}}, {{an}} here. Prices shifted near {{soldAddr}}. {{activeAddr}} well-priced, {{details}}. {{cta}} Cheers, {{an}}",
    "Hi {{fn}}, heads up from {{an}}. {{activeAddr}} priced right, {{details}}. Similar to what you liked at {{soldAddr}}. {{cta}} {{an}}",
  ],
  "Life Check-In": [
    "Hi {{fn}}, {{an}} here. How's the search since {{soldAddr}}? Got {{activeAddr}} coming up, {{details}}. {{cta}} Cheers, {{an}}",
    "Hi {{fn}}, {{an}} checking in. Still looking? {{activeAddr}} just came up, {{details}}. {{cta}} Cheers, {{an}}",
    "Hi {{fn}}, hope you're well. {{an}} here, {{activeAddr}} just listed, {{details}}. Thought of you. {{cta}} {{an}}",
  ],
  "Competition Signal": [
    "Hi {{fn}}, {{an}} here. {{activeAddr}} getting strong interest, {{details}}. Thought of you from {{soldAddr}}. {{cta}} Cheers, {{an}}",
    "Hi {{fn}}, quick one from {{an}}. {{activeAddr}} drawing buyers, {{details}}. Worth a look before Sat. {{cta}} {{an}}",
  ],
  "Social Proof Drop": [
    "Hi {{fn}}, {{an}} here. Another buyer just purchased nearby. {{activeAddr}} still available, {{details}}. {{cta}} Cheers, {{an}}",
    "Hi {{fn}}, {{an}} from {{soldAddr}}. Someone similar just bought in the area. {{activeAddr}}, {{details}}. {{cta}} {{an}}",
  ],
  "Investment Angle Flip": [
    "Hi {{fn}}, {{an}} here. {{activeAddr}} stacks up as an investment, {{details}}. Thought of you from {{soldAddr}}. {{cta}} Cheers, {{an}}",
    "Hi {{fn}}, quick one from {{an}}. {{activeAddr}} strong rental yield, {{details}}. {{cta}} Cheers, {{an}}",
  ],
  "SMS Drip Sequence": [
    "Hi {{fn}}, {{an}} here. Still have {{activeAddr}} on my mind for you, {{details}}. {{cta}} Cheers, {{an}}",
    "Hi {{fn}}, {{an}} again. {{activeAddr}} open this week, {{details}}. Worth a look? Cheers, {{an}}",
  ],
  "Phone Script": [
    "Hi {{fn}}, {{an}} here. Tried calling, {{activeAddr}} just listed, {{details}}. Give me a buzz when free? Cheers, {{an}}",
    "Hi {{fn}}, {{an}} here. Missed you, {{activeAddr}} came up, {{details}}. Call me back when suits? {{an}}",
  ],
  "Vendor Advocate": [
    "Hi {{fn}}, {{an}} here. Got an off-market at {{activeAddr}}, {{details}}. Perfect for what you described at {{soldAddr}}. {{cta}} {{an}}",
    "Hi {{fn}}, {{an}} here. Before it hits the market, {{activeAddr}}, {{details}}. Keen for first look? Cheers, {{an}}",
  ],
}

const DEFAULT_SMS = [
  "Hi {{fn}}, {{an}} here from the {{soldAddr}} open. Got one at {{activeAddr}}, {{details}}. {{cta}} Cheers, {{an}}",
  "Hi {{fn}}, {{an}} here. Thought of you for {{activeAddr}}, {{details}}. {{cta}} Cheers, {{an}}",
]
...
export function generateFromTemplate(params: {
  ...
  const { agentName, soldShortAddr, activeShortAddr, lead, strategy } = params
  ...
  const slots: Slots = { fn, an, soldAddr, activeAddr, details, cta }
  ...
  if (sms.length > 160) sms = sms.slice(0, 157).trimEnd() + "..."
