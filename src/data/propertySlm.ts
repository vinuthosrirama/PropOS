...
export const SLM_DATA: Record<number, PropertySLM> = {
  ...
  // -------------------------------------------------------------------------
  // 109 — 7 Atkinson Drive, Berwick (ACTIVE LISTING — $865K–$950K, listed 30 Jun 2026)
  // SLM data: logical estimates derived from price, suburb, and bed/bath/car count —
  // not sourced from a Section 32. Legal fields describe what is TYPICAL for a
  // Berwick title of this age rather than this property's actual documents; treat
  // as a starting point for buyer conversations, not a substitute for the vendor's
  // Section 32. Confirm all legal/title specifics before contract.
  // -------------------------------------------------------------------------
  109: {
    propertyId: 109,
    address: "7 Atkinson Drive",
    suburb: "Berwick VIC 3806",
    status: "active",
    ...
    frontageMetre: 16.5,
    depthMetre: 39.4,
    propertyShape: "Approximately rectangular standard estate lot — confirm exact boundaries via title plan.",
    orientation: "TBD — confirm at inspection",
    pool: false,
    gardenSqm: 160,
    shed: false,
    outdoorEntertaining: true,
    alfrescoSqm: 18,
    roofType: "Concrete tile (typical for the estate and era)",
    externalCladding: "Brick veneer (typical for a 2008-era Berwick estate home)",
    construction: "Brick veneer",
    floorplanConfig: "4 bed, 2 bath, double garage",

    // LEGAL & TITLE
    titleType: "Torrens title — standard for this estate. Exact volume/folio to be confirmed via Section 32 from the vendor's conveyancer.",
    easements: "Not yet confirmed. Standard drainage/sewerage easements are common on estate lots of this age; request the Section 32 plan of subdivision before making an offer.",
    covenants: "Not yet confirmed. Many Berwick estates from the 2000s carry a design covenant (min floor area, brick veneer construction, front setback). Request covenant terms from the vendor's conveyancer.",
    overlays: "None identified — established Berwick residential estate. Confirm with a Casey Council planning certificate (s199).",
    s32Status: "Not yet issued to PropOS — request from the listing agent's conveyancer.",
    encumbrances: "TBD — confirm via Section 32 whether a mortgage or other registered encumbrance must be discharged at settlement.",
    ownerOccupied: true,
    zoning: "General Residential Zone (GRZ1) — typical for established Berwick estates. Confirm with Casey Council.",
    rightOfWay: "None identified",
    sewerEasement: "TBD — confirm via Section 32 plan",
    contaminatedLand: false,
    buildingPermitsOutstanding: "TBD — request a Casey Council building surveying certificate",
    ownerBuilderWork: false,
    titlesOfficeReady: true,
    section32CompletionDate: "TBD",
    ...
    priceMin: 865000,
    priceMax: 950000,
    vendorReserve: 907500,
    settlementTermsDays: 60,
    depositPct: 10,
    rentalAppraisalLow: 520,
    rentalAppraisalHigh: 550,
    grossYieldAtAsk: 3.1,
    councilRates: 2450,
    waterRates: 720,
    bodyCorporateFees: 0,
    stampDutyEstimate: 49700,
    landTaxThreshold: "Owner-occupied — exempt as PPOR if the vendor lives here. An investor purchaser should calculate land tax separately based on site value once available.",
    depreciationYear1Est: 7800,
    capitalGainsHistory: "Not yet available — request purchase history from the vendor's conveyancer via Section 32.",

    // LOCATION & SUBURB
    primarySchool: "Berwick Chase Primary School (confirm zone with Casey Council)",
    primarySchoolRating: "Good — NAPLAN above state average in reading and numeracy",
    secondarySchool: "Berwick Secondary College (confirm zone with Casey Council)",
    secondarySchoolRating: "Average — large campus, P-12 options. Nossal High School (selective entry, approx 9km) is a popular choice for high achievers.",
    schoolZoneCatchment: "Likely Berwick Chase Primary and Berwick Secondary College — confirm with Casey Council using the exact address",
    distanceToTrainKm: 2.2,
    trainLine: "Pakenham Line (Berwick Station approx 2.2km)",
    distanceToFreewayKm: 1.8,
    distanceToShoppingKm: 2.4,
    ...
    clearanceRatePct: 74,
    comparableSales: [
      { address: "34 Hartsmere Drive, Berwick", price: 880000, date: "03 Jul 2026", beds: 4 },
      { address: "3 Thirlmere Court, Berwick", price: 941000, date: "02 May 2026", beds: 4 },
      { address: "3 Yemaya Place, Berwick", price: 1100000, date: "11 May 2026", beds: 4 },
    ],

    // FEATURES & CONDITION
    kitchenRenovated: "Original kitchen for the build era — condition to be confirmed at inspection",
    bathroomRenovated: "Original bathrooms for the build era — condition to be confirmed at inspection",
    flooringType: "Carpet to bedrooms, tiles to living and wet areas (typical for the era)",
    airConType: "Split-system or ducted (confirm at inspection)",
    heatingType: "Ducted or split-system (confirm at inspection)",
    solarKw: 0,
    batteryStorage: false,
    evCharging: false,
    nbnType: "FTTN (Fibre to the Node) — typical for established Berwick estates",
    waterTank: false,
    alarmSystem: false,
    smartHome: false,
    disabilityAccess: false,
    petsAllowed: true,
    outdoorFeatures: "Double garage, alfresco entertaining area",

    // PLANNING & VENDOR
    subdivisionPotential: false,
    dualOccupancyPotential: false,
    grannyFlatApproved: false,
    extensionPotential: "Possible subject to Casey Council planning permit and any registered covenant setbacks — confirm zoning before committing to a design.",
    councilDevelopmentHistory: "Not yet confirmed — request from Casey Council",
    neighbourhoodDescription: "Established Berwick residential estate, Casey City Council. Close to Berwick Village and the Pakenham train line.",
    trafficNoiseLevel: "Low — residential street, not a through road",
    flightPathFlag: false,
    futureInfrastructure: "Casey growth corridor — general area development ongoing. No specific works identified for this address.",
    floodZone: false,
    vendorMotivation: "Not yet disclosed — ask the listing agent",
    vendorTimelineDays: 60,
    previousOffers: false,
    daysOnMarket: 9,
    priceReductionHistory: "No reductions — fresh to market, listed 30 Jun 2026",
    tenantInPlace: false,
    tenantLeaseEndDate: "N/A — vacant possession expected at settlement, confirm with vendor",
    vendorPreferredSettlement: "60 days (standard, confirm flexibility with listing agent)",
    vendorFlexOnInclusions: "Standard inclusions — confirm exact fixtures and fittings via Section 32",
    inclusions: "TBD — confirm exact fixtures and fittings via Section 32",

    qa: [
      {
        question: "What is the land size?",
        answer: "Approximately 650 sqm (estimate based on typical lot sizes for this street and era — confirm exact figure via the title plan or Section 32).",
        category: "physical",
        keywords: ["land", "lot", "sqm", "block", "size", "m2", "square", "title"],
      },
      {
        question: "What are the council rates?",
        answer: "Approximately $2,450 per year, in line with other Berwick homes in this price range. Confirm the exact figure via a Casey City Council rates certificate.",
        category: "financial",
        keywords: ["council", "rates", "annual", "levy", "casey"],
      },
      {
        question: "What are the water rates?",
        answer: "Approximately $720 per year (South East Water), consistent with other properties in the area. Confirm via a South East Water information statement.",
        category: "financial",
        keywords: ["water", "rates", "south east water", "sewerage", "annual", "sew"],
      },
      {
        question: "What school zone is this in?",
        answer: "Likely Berwick Chase Primary School and Berwick Secondary College, both well regarded locally. Confirm the exact catchment with Casey Council using this address, as zone boundaries can be street-specific.",
        category: "location",
        keywords: ["school", "zone", "catchment", "primary", "secondary", "education"],
      },
      {
        question: "How far to the train station?",
        answer: "Approximately 2.2km to Berwick Station on the Pakenham line.",
        category: "location",
        keywords: ["train", "station", "pakenham", "distance", "commute"],
      },
      {
        question: "Is there a pool or spa?",
        answer: "No — not identified in the listing. Confirm at inspection.",
        category: "physical",
        keywords: ["pool", "spa", "swimming", "water", "feature"],
      },
      {
        question: "What comparable sales support this price?",
        answer: "34 Hartsmere Drive sold 03 Jul 2026 for $880,000 (4 bed). 3 Thirlmere Court sold 02 May 2026 for $941,000 (4 bed). 3 Yemaya Place sold 11 May 2026 for $1,100,000 (4 bed). This property's $865K-$950K guide sits at the lower-to-mid end of recent 4-bed Berwick results.",
        category: "financial",
        keywords: ["comparable", "sales", "recent", "sold", "comps", "market", "evidence"],
      },
      {
        question: "What is the rental yield if I buy as an investor?",
        answer: "Estimated rental appraisal of $520-$550 per week, which is approximately 3.0-3.1% gross yield at the current price guide. Get a formal rental appraisal before committing.",
        category: "financial",
        keywords: ["rental", "yield", "investor", "appraisal", "income", "return"],
      },
      {
        question: "Is there a mortgage or other encumbrance to discharge?",
        answer: "Not yet confirmed. This will be disclosed in the vendor's Section 32 — request it from the listing agent before making an offer.",
        category: "legal",
        keywords: ["mortgage", "loan", "bank", "discharge", "encumbrance", "title"],
      },
      {
        question: "What is the land tax situation?",
        answer: "If the vendor lives here as their principal residence, the property is land-tax exempt in their hands. An investor purchaser should calculate land tax separately once site value is available.",
        category: "financial",
        keywords: ["land tax", "sro", "investor", "ppor", "exempt"],
      },
      {
        question: "Is this a flood zone or bushfire prone area?",
        answer: "Not flagged as a flood zone based on the general area. Confirm with a South East Water information statement and Casey Council planning certificate before purchase.",
        category: "planning",
        keywords: ["flood", "flooding", "flood zone", "bushfire", "risk"],
      },
      {
        question: "What is included in the sale?",
        answer: "Not yet confirmed — standard fixtures and fittings are expected. Exact inclusions will be listed in the Section 32 contract of sale.",
        category: "legal",
        keywords: ["inclusions", "fixtures", "fittings", "included"],
      },
    ],
  },

  // -------------------------------------------------------------------------
  // 111 — 22 Riviera Drive, Berwick (ACTIVE LISTING — $1.05M–$1.15M, listed 23 Jun 2026)
  // SLM data: logical estimates, same basis and caveats as 7 Atkinson Drive above.
  // -------------------------------------------------------------------------
  111: {
    propertyId: 111,
    ...
    alfrescoSqm: 22,
    roofType: "Concrete tile (typical for the estate and era)",
    externalCladding: "Brick veneer with render accents (typical for a 2012-era Berwick estate home)",
    construction: "Brick veneer",
    floorplanConfig: "4 bed, 2 bath, double garage",

    // LEGAL & TITLE
    titleType: "Torrens title — standard for this estate. Exact volume/folio to be confirmed via Section 32 from the vendor's conveyancer.",
    easements: "Not yet confirmed. Request the Section 32 plan of subdivision before making an offer.",
    covenants: "Not yet confirmed. Request covenant terms from the vendor's conveyancer.",
    overlays: "None identified — established Berwick residential estate. Confirm with a Casey Council planning certificate (s199).",
    s32Status: "Not yet issued to PropOS — request from the listing agent's conveyancer.",
    encumbrances: "TBD — confirm via Section 32 whether a mortgage or other registered encumbrance must be discharged at settlement.",
    ownerOccupied: true,
    ...
    settlementTermsDays: 60,
    depositPct: 10,
    rentalAppraisalLow: 630,
    rentalAppraisalHigh: 660,
    grossYieldAtAsk: 3.0,
    councilRates: 2850,
    waterRates: 740,
    bodyCorporateFees: 0,
    stampDutyEstimate: 60500,
    landTaxThreshold: "Owner-occupied — exempt as PPOR if the vendor lives here. An investor purchaser should calculate land tax separately based on site value once available.",
    depreciationYear1Est: 9600,
    capitalGainsHistory: "Not yet available — request purchase history from the vendor's conveyancer via Section 32.",
    ...
    secondarySchoolRating: "Average — large campus, P-12 options. Nossal High School (selective entry, approx 9km) is a popular choice for high achievers.",
    schoolZoneCatchment: "Likely Berwick Chase Primary and Berwick Secondary College — confirm with Casey Council using the exact address",
    distanceToTrainKm: 1.9,
    trainLine: "Pakenham Line (Berwick Station approx 1.9km)",
    distanceToFreewayKm: 1.5,
    distanceToShoppingKm: 2.0,
    nearestHospitalKm: 7.5,
    suburb5yrGrowthPct: 28,
    suburbMedianPrice: 920000,
    daysOnMarketAvg: 32,
    clearanceRatePct: 74,
    comparableSales: [
      { address: "3 Thirlmere Court, Berwick", price: 941000, date: "02 May 2026", beds: 4 },
      { address: "3 Yemaya Place, Berwick", price: 1100000, date: "11 May 2026", beds: 4 },
      { address: "5 Ascot Rise, Berwick", price: 1300000, date: "22 Apr 2026", beds: 4 },
    ],

    // FEATURES & CONDITION
    kitchenRenovated: "Original kitchen for the build era, likely stone benchtops given the 2012 build date — condition to be confirmed at inspection",
    bathroomRenovated: "Original bathrooms for the build era — condition to be confirmed at inspection",
    flooringType: "Carpet to bedrooms, tiles or floating floors to living and wet areas (typical for the era)",
    airConType: "Ducted (typical for a home of this size and era)",
    heatingType: "Ducted",
    solarKw: 0,
    batteryStorage: false,
    evCharging: false,
    ...
    disabilityAccess: false,
    petsAllowed: true,
    outdoorFeatures: "Double garage, alfresco entertaining area, larger 700sqm block",
    ...
    previousOffers: false,
    daysOnMarket: 16,
    priceReductionHistory: "No reductions — fresh to market, listed 23 Jun 2026",
    tenantInPlace: false,
    tenantLeaseEndDate: "N/A — vacant possession expected at settlement, confirm with vendor",
    vendorPreferredSettlement: "60 days (standard, confirm flexibility with listing agent)",
    vendorFlexOnInclusions: "Standard inclusions — confirm exact fixtures and fittings via Section 32",
    ...
    qa: [
      {
        question: "What is the land size?",
        answer: "Approximately 700 sqm (estimate based on typical lot sizes for this street and era — confirm exact figure via the title plan or Section 32).",
        category: "physical",
        keywords: ["land", "lot", "sqm", "block", "size", "m2", "square", "title"],
      },
      {
        question: "What are the council rates?",
        answer: "Approximately $2,850 per year, in line with other Berwick homes in this price range. Confirm the exact figure via a Casey City Council rates certificate.",
        category: "financial",
        keywords: ["council", "rates", "annual", "levy", "casey"],
      },
      {
        question: "What are the water rates?",
        answer: "Approximately $740 per year (South East Water). Confirm via a South East Water information statement.",
        category: "financial",
        keywords: ["water", "rates", "south east water", "sewerage", "annual", "sew"],
      },
      {
        question: "What school zone is this in?",
        answer: "Likely Berwick Chase Primary School and Berwick Secondary College. Confirm the exact catchment with Casey Council using this address, as zone boundaries can be street-specific.",
        category: "location",
        keywords: ["school", "zone", "catchment", "primary", "secondary", "education"],
      },
      {
        question: "How far to the train station?",
        answer: "Approximately 1.9km to Berwick Station on the Pakenham line.",
        category: "location",
        keywords: ["train", "station", "pakenham", "distance", "commute"],
      },
      {
      ...
      {
        question: "What comparable sales support this price?",
        answer: "3 Thirlmere Court sold 02 May 2026 for $941,000 (4 bed). 3 Yemaya Place sold 11 May 2026 for $1,100,000 (4 bed). 5 Ascot Rise sold 22 Apr 2026 for $1,300,000 (4 bed). This property's $1.05M-$1.15M guide sits comfortably within recent 4-bed Berwick results for a larger block.",
        category: "financial",
        keywords: ["comparable", "sales", "recent", "sold", "comps", "market", "evidence"],
      },
      {
        question: "What is the rental yield if I buy as an investor?",
        answer: "Estimated rental appraisal of $630-$660 per week, approximately 3.0% gross yield at the current price guide. Get a formal rental appraisal before committing.",
        category: "financial",
        keywords: ["rental", "yield", "investor", "appraisal", "income", "return"],
      },
      {
  ...
  // -------------------------------------------------------------------------
  // 114 — 39 Ashbury Rise, Berwick (ACTIVE LISTING — $850K–$895K, listed 10 Jun 2026)
  // SLM data: logical estimates, same basis and caveats as 7 Atkinson Drive above.
  // -------------------------------------------------------------------------
  114: {
    propertyId: 114,
    address: "39 Ashbury Rise",
    suburb: "Berwick VIC 3806",
    status: "active",
    ...
    alfrescoSqm: 16,
    roofType: "Concrete tile (typical for the estate and era)",
    externalCladding: "Brick veneer (typical for a 2006-era Berwick estate home)",
    construction: "Brick veneer",
    floorplanConfig: "4 bed, 2 bath, double garage",
    ...
    waterRates: 710,
    bodyCorporateFees: 0,
    stampDutyEstimate: 47600,
    landTaxThreshold: "Owner-occupied — exempt as PPOR if the vendor lives here. An investor purchaser should calculate land tax separately based on site value once available.",
    depreciationYear1Est: 7400,
    capitalGainsHistory: "Not yet available — request purchase history from the vendor's conveyancer via Section 32.",
    ...
    secondarySchoolRating: "Average — large campus, P-12 options. Nossal High School (selective entry, approx 9km) is a popular choice for high achievers.",
    schoolZoneCatchment: "Likely Berwick Chase Primary and Berwick Secondary College — confirm with Casey Council using the exact address",
    distanceToTrainKm: 2.6,
    trainLine: "Pakenham Line (Berwick Station approx 2.6km)",
    distanceToFreewayKm: 2.0,
    distanceToShoppingKm: 1.8,
    nearestHospitalKm: 8.1,
    suburb5yrGrowthPct: 28,
    suburbMedianPrice: 920000,
    ...
    disabilityAccess: false,
    petsAllowed: true,
    outdoorFeatures: "Double garage, outdoor entertaining area",
    ...
    extensionPotential: "Possible subject to Casey Council planning permit and any registered covenant setbacks — confirm zoning before committing to a design.",
    councilDevelopmentHistory: "Not yet confirmed — request from Casey Council",
    neighbourhoodDescription: "Established Berwick residential estate, Casey City Council. Close to Eden Rise shopping centre and the Pakenham train line.",
    trafficNoiseLevel: "Low — residential street, not a through road",
    flightPathFlag: false,
    futureInfrastructure: "Casey growth corridor — general area development ongoing. No specific works identified for this address.",
    floodZone: false,
    ...
    previousOffers: false,
    daysOnMarket: 29,
    priceReductionHistory: "No reductions — fresh to market, listed 10 Jun 2026",
    tenantInPlace: false,
    tenantLeaseEndDate: "N/A — vacant possession expected at settlement, confirm with vendor",
    vendorPreferredSettlement: "60 days (standard, confirm flexibility with listing agent)",
    vendorFlexOnInclusions: "Standard inclusions — confirm exact fixtures and fittings via Section 32",
    ...
    qa: [
      {
        question: "What is the land size?",
        answer: "Approximately 600 sqm (estimate based on typical lot sizes for this street and era — confirm exact figure via the title plan or Section 32).",
        category: "physical",
        keywords: ["land", "lot", "sqm", "block", "size", "m2", "square", "title"],
      },
      {
        question: "What are the council rates?",
        answer: "Approximately $2,360 per year, in line with other Berwick homes in this price range. Confirm the exact figure via a Casey City Council rates certificate.",
        category: "financial",
        keywords: ["council", "rates", "annual", "levy", "casey"],
      },
      {
        question: "What are the water rates?",
        answer: "Approximately $710 per year (South East Water). Confirm via a South East Water information statement.",
        category: "financial",
        keywords: ["water", "rates", "south east water", "sewerage", "annual", "sew"],
      },
      {
      ...
      {
        question: "How close is it to Eden Rise shops?",
        answer: "Approximately 1.8km — a short drive to Eden Rise Shopping Centre.",
        category: "location",
        keywords: ["shops", "shopping", "eden rise", "distance", "convenience"],
      },
      {
        question: "Is there a pool or spa?",
        answer: "No — not identified in the listing. Confirm at inspection.",
      ...
      {
        question: "What comparable sales support this price?",
        answer: "34 Hartsmere Drive sold 03 Jul 2026 for $880,000 (4 bed). 3 Thirlmere Court sold 02 May 2026 for $941,000 (4 bed). This property's $850K-$895K guide sits just below those results, consistent with its smaller 600sqm block.",
        category: "financial",
        keywords: ["comparable", "sales", "recent", "sold", "comps", "market", "evidence"],
      },
      {
        question: "What is the rental yield if I buy as an investor?",
        answer: "Estimated rental appraisal of $500-$530 per week, approximately 3.0% gross yield at the current price guide. Get a formal rental appraisal before committing.",
        category: "financial",
        keywords: ["rental", "yield", "investor", "appraisal", "income", "return"],
      },
      {
