...
export const PORTFOLIO_SOLD: PortfolioProperty[] = [
  {
    ...
    price: 880000, beds: 4, baths: 2, cars: 2, land: 621,
    type: "House", status: "sold", soldDate: "03 Jul 2026",
  ...
  },
  {
    ...
    suburb: "Berwick", state: "VIC", postcode: "3806",
    price: 1300000, beds: 4, baths: 2, cars: 2, land: 754,
    type: "House", status: "sold", soldDate: "22 Apr 2026",
...
// Replaced 10 Ashby Drive / 3 Fairholme Boulevard with Cameron's current live listings
// (source: agent-supplied, 9 Jul 2026). Old SLM_DATA entries for ids 101/105 are left in
// place (unreferenced, harmless) rather than deleted — see propertySlm.ts.
export const PORTFOLIO_ACTIVE: PortfolioProperty[] = [
  {
    id: 108,
    address: "1-2 Maclaine Court",
    suburb: "Narre Warren North", state: "VIC", postcode: "3805",
    price: 2200000, priceMin: 2100000, priceMax: 2300000,
    beds: 5, baths: 4, cars: 6,
    type: "House", status: "active",
  ...
  },
  {
    ...
    suburb: "Berwick", state: "VIC", postcode: "3806",
    price: 907500, priceMin: 865000, priceMax: 950000,
    beds: 4, baths: 2, cars: 2,
    type: "House", status: "active",
    image: "/7-atkinson-drive.jpg",
    description: "4-bed family home with double garage in established Berwick. Listed 30 Jun 2026.",
    leadCount: 0,
  },
  {
    id: 110,
    address: "12 Carambola Place",
    suburb: "Berwick", state: "VIC", postcode: "3806",
    price: 1170000, priceMin: 1120000, priceMax: 1220000,
  ...
  },
  {
    ...
    suburb: "Berwick", state: "VIC", postcode: "3806",
    price: 1100000, priceMin: 1050000, priceMax: 1150000,
    beds: 4, baths: 2, cars: 2,
    type: "House", status: "active",
    image: "/22-riviera-drive.jpg",
    description: "4-bed family home with double garage in Berwick. Listed 23 Jun 2026.",
    leadCount: 0,
  },
  {
    id: 112,
    address: "40 Highvale Crescent",
    suburb: "Berwick", state: "VIC", postcode: "3806",
    price: 1300000, priceMin: 1250000, priceMax: 1350000,
  ...
  {
    id: 113,
    address: "5/5-17 William Road",
    suburb: "Berwick", state: "VIC", postcode: "3806",
    price: 645000, priceMin: 620000, priceMax: 670000,
    beds: 2, baths: 2, cars: 2,
    type: "Unit", status: "active",
  ...
  },
  {
    ...
    suburb: "Berwick", state: "VIC", postcode: "3806",
    price: 872500, priceMin: 850000, priceMax: 895000,
    beds: 4, baths: 2, cars: 2,
    type: "House", status: "active",
    image: "/39-ashbury-rise.jpg",
    description: "4-bed family home with double garage in Berwick. Listed 10 Jun 2026.",
    leadCount: 0,
  },
]
